...
public class FarmListAdapter extends ArrayAdapter {
	
	private Context context;
	private ArrayList<Farm> farms = new ArrayList<Farm>();
	
	@SuppressWarnings("unchecked")
	public FarmListAdapter(Context ctxt, int textViewResourceId, ArrayList<Farm> farms) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {	
		...
		if (convertView == null) {
			...
			itemView = inflater.inflate(R.layout.farm_list_item, null);
